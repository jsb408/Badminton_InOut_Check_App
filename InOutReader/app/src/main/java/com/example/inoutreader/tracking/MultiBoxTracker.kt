...
==============================================================================*/
package com.example.inoutreader.tracking
...
import com.example.inoutreader.env.BorderedText
import com.example.inoutreader.env.ImageUtils
import java.util.*
...
class MultiBoxTracker(context: Context) {
    ...
    val screenRects = LinkedList<Pair<Float, RectF>>()
    ...
    @Synchronized
    fun setFrameConfiguration(width: Int, height: Int, inputSize: Int, sensorOrientation: Int) {
        frameWidth = width
        frameHeight = height
    ...
    fun draw(canvas: Canvas) {
        ...
        Log.d(TAG, "FRAME : $frameWidth x $frameHeight")
    ...
    private fun processResults(results: List<Recognition>) {
        ...
        for (result in results) {
            ...
            Log.v(TAG, "Result! Frame: " + result.location.toString() + " mapped to screen:" + detectionScreenRect)
